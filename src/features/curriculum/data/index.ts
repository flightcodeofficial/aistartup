...
export const week3: WeekMeta = {
  ...
  days: [
    ...
    openDay(3, 9, "DAY 9 — Business Plan Blueprint부터 AI Critic까지: 사업을 문서로 완성하기", "지금까지의 결정을 Business Plan Blueprint로 재배열하고 AI로 Draft를 작성한 뒤, Service Introduction으로 고객용 문서를 만들고 AI Critic으로 두 문서의 논리적 정합성을 검증합니다."),
  ],
};
...
export const week4: WeekMeta = {
  ...
  days: [
    ...
    openDay(4, 13, "DAY 13 — Process Standardization부터 AI Operation System까지: 반복 업무를 운영체계로", "Process Standardization Map으로 Sales 흐름을 구조화하고, Customer Response Automation Map으로 자동응답 경계를 설계한 뒤, Make Workflow Build & Test로 실제 작동시키고, AI Operation System으로 Process·Workflow·Human Decision을 하나의 운영체계로 연결합니다."),
    ...Array.from({ length: 2 }, (_, i) => placeholderDay(4, i + 14)),
  ],
};
